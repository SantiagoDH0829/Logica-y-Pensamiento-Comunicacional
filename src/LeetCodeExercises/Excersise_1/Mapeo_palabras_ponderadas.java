...
public class Mapeo_palabras_ponderadas {
    public static void main(String[] args) {

        String[] words = new String[] {"abcd","def" , "xyz"};
        int[] weights =  new int[] {5,3,12,14,1,2,3,2,10,6,6,9,7,8,7,10,8,9,6,9,9,8,3,7,7,2};

        Solution_E_1 s1 = new Solution_E_1();
        System.out.println(s1.MySolution(words, weights));
        System.out.println(s1.Solution(words, weights));
    }
}
